...
export function getInitial() {
  return {
    ...
    // Myosa TMJBDS Patientenauswertung (Sektion 13)
    myosa_main_complaints: null,
    myosa_treatment_goals: null,
    myosa_headache: null, myosa_headache_intensity: null,
    myosa_neck_pain: null, myosa_neck_pain_intensity: null,
    myosa_joint_clicking: null, myosa_joint_clicking_intensity: null,
    myosa_limited_opening: null, myosa_limited_opening_intensity: null,
    myosa_max_opening_mm: null,
    myosa_ear_pain_tinnitus: null, myosa_ear_pain_intensity: null,
    myosa_atypical_facial_pain: null, myosa_facial_pain_intensity: null,
    myosa_breathing_mode: null,
    myosa_lip_closure: null,
    myosa_tonsils_grade: null,
    myosa_snoring: null, myosa_apnea: null,
    myosa_restless_sleep: null, myosa_morning_fatigue: null,
    myosa_sleep_study_done: null,
    myosa_tongue_position: null,
    myosa_tongue_correction_needed: null,
    myosa_swallow_tongue_thrust: null,
    myosa_swallow_mentalis_activity: null,
    myosa_swallow_myofunctional_therapy_needed: null,
    myosa_cheek_muscles: null,
    myosa_cheek_exercises_needed: null,
    myosa_maxilla_shape: null,
    myosa_crowding: null,
    myosa_class: null,
    myosa_bite: null,
    myosa_posture_head_forward: null,
    myosa_posture_pelvic_tilt: null,
    myosa_posture_shoulder_drop: null,
    myosa_recommended_appliance: null,
    myosa_special_notes: null,
  };
}
...
export const DEMO_UTTERANCES = [
  ...
  "Schmerzen an den Schläfen links und im Nacken beidseits, ausstrahlend in die Schulter",
  ...
  "Vertikale Kieferrelation unauffällig, kein Gleiten zwischen ZO und HO",
  "Abrasionen vorhanden, Zungenimpressionen, keine Wangenimpressionen",
